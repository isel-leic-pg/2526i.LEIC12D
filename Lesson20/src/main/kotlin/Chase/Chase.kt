...
private fun List<Garbage>.drawGarbage() {
    this.forEach {
        c.drawImage("garbage.png", it.position.col.toGridPosition() , it.position.row.toGridPosition(), HERO_SPRITE_WIDTH, HERO_SPRITE_HEIGHT)
    }
}
